...
export default function BarcodeScanner({ onDetected, onNoCamera }: BarcodeScannerProps) {
    ...
    useEffect(() => {
        ...
        async function startCamera() {
            ...
            try {
                ...
                const videoInputDevices = devices.filter((d): d is MediaDeviceInfo => d.kind === "videoinput");
                ...
                await codeReaderRef.current!.decodeFromVideoDevice(
                    ...
                    (result: Result | undefined, err: unknown) => {
                        ...
                        if (err && (err as { name?: string }).name !== "NotFoundException") {
                            ...
                            // Jika err adalah Error, ambil message-nya, jika tidak gunakan string umum
    ...
    }, [onDetected, onNoCamera]);

    // Handle upload gambar barcode sebagai fallback
